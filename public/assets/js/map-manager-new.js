                    ...
                    ">
                        ...
                        <div style="flex: 1; min-width: 0;">
                            <span style="
                                ...
                                margin-bottom: 3px;
                            ">الهاتف:</span>
                            <a href="tel:${clientData.phone || ''}" style="
                                color: ${statusColor};
...
// ===== 2. عدّل وظيفة addCenterMapButton لتضيف كلا الزرين =====
// استبدل الوظيفة الحالية بهذه:
