 <div class="card shadow-sm border-0 rounded-3" id="actionCard">
     <div class="card-body p-3">
         <div class="d-flex flex-wrap justify-content-end align-items-center" style="gap: 10px;">
             ...
             <!-- زر تصدير PDF -->
             <div class="dropdown">
                 <button class="btn bg-white border d-flex align-items-center justify-content-center"
                     style="width: 44px; height: 44px; border-radius: 6px;" title="تصدير PDF" id="exportDropdown"
                 ...
                 <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                     <li>
                         <a class="dropdown-item" href="{{ route('clients.export-pdf', ['type' => 'filtered']) }}">
                             <i class="fas fa-filter me-2 text-info"></i> تصدير حسب الفلترة
                         </a>
                     </li>
                     <li>
                         <a class="dropdown-item" href="{{ route('clients.export-pdf', ['type' => 'page']) }}">
                             <i class="fas fa-list-ol me-2 text-success"></i> تصدير الصفحة الحالية
                         </a>
                     </li>
                     <li>
                         <a class="dropdown-item" href="{{ route('clients.export-pdf', ['type' => 'all']) }}">
                             <i class="fas fa-globe me-2 text-danger"></i> تصدير الكل
                         </a>
                     </li>
                 </ul>
             </div>
     ...
     document.addEventListener('DOMContentLoaded', function() {
         ...
         document.getElementById('exportPdfBtn')?.addEventListener('click', async function() {
             ...
             try {
                 ...
                 doc.setFontSize(16);
                 doc.text('قائمة العملاء', doc.internal.pageSize.width / 2, 15, {
                     align: 'center'
                 });

                 const today = new Date().toLocaleDateString('ar-SA');
                 doc.setFontSize(10);
                 doc.text('تاريخ التصدير: ' + today, doc.internal.pageSize.width - 15, 15, {
                     align: 'right'
                 });
