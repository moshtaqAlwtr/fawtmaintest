...
<div class="calendar-container">
    <div class="calendar-header">
        ...
        <div class="view-filters">
            <button class="filter-btn active" onclick="filterBookings('all', event)">الكل</button>
...
<script>
    // Check if calendarBookings data exists, if not initialize as empty object
    const bookingsData = typeof calendarBookings !== 'undefined' ? calendarBookings : {};
    ...
    // Generate calendar when DOM is loaded
