                ...
                @if (isset($settings['purchase_cycle']) && $settings['purchase_cycle'] === 'active')
                    <li class=" nav-item"><a href="index.html">
                        ...
                        <ul class="menu-content">
                            ...
                            <li><a href="{{ route('purchases.invoice_settings.index') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item"
                                        data-i18n="eCommerce">
                            ...
                            <li><a href="{{ route('ReportsPurchases.index') }}"><i
                                        class="feather icon-circle"></i><span class="menu-item"
                ...
                @if (isset($settings['manufacturing']) && $settings['manufacturing'] === 'active')
                    <li class="nav-item {{ request()->is("$getLocal/Manufacturing/*") ? 'active open' : '' }}">
                        ...
                        <ul class="menu-content">
                            ...
                            <li><a href="{{ route('ReportsProduction.index') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="eCommerce">تقرير التصنيع </span></a>
                            </li>
                        </ul>
                    </li>
                @endif
