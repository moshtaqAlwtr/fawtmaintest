...
class ClientRelation extends Model
{
    ...
    protected $fillable = ['client_id', 'status','quotation_id', 'process', 'time', 'date', 'employee_id', 'description', 'location_id','type', 'deposit_count', 'employee_view_status', 'site_type','invoice_id', 'competitor_documents', 'additional_data', 'attachments'];
